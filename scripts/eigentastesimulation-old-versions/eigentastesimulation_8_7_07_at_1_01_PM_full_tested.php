...
function runSimulation($connection)
{
	...
	runSimulationUsersRatedX($connection, $meanweight, $numjokestoratearray, $e2plot, $prede2plot, $pte2plot, $ptprede2plot, $e3plot, $prede3plot, $pte3plot, $ptprede3plot, $se2plot, $sprede2plot, $se3plot, $sprede3plot, $initialratedjokes);
...
{	
	...
	runSimulationE3UsersRatedX($connection, $meanweight, $numjokestoratearray, $pte3plot, $ptprede3plot, $initialratedjokes);
...
/* Tested - works */
function runSimulationE3UsersRatedX($connection, $meanweight, &$numjokestoratearray, &$pte3plot, &$ptprede3plot, $initialratedjokes)
{		
	global $predictjokes, $numjokes;
...
function matchWithCluster($connection, $userid)
{
	...
	{
		echo "Error: matchWithCluster should not have been called!\n";
		exit;
	}
}
*/
