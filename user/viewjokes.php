...
<div id="main">
<form action="../user/viewjokes.php" method="get">
<p>
Joke ID #1: <input name="jokeid1" type="text" maxlength="3" size="3" value="<?php print $jokeid1 ?>" /> <span class="separator">|</span>
Joke ID #2: <input name="jokeid2" type="text" maxlength="3" size="3" value="<?php print $jokeid2 ?>" /> <span class="separator">|</span> <input name="submit" type="submit" value="View" /><input name="reset" type="button" value="Reset" onclick="window.location.href = '../user/viewjokes.php'" />
</p>
</form>
</div>
